...
public class NewsongRepository {
	...
	public Page<SongDto.SearchRes> multiMatchQuery(SearchReq dto, Pageable pageable) {
		// create builder
		SearchSourceBuilder searchSourceBuilder = createSearchSourceBuilder(dto, pageable);
	...
	private SearchSourceBuilder createSearchSourceBuilder(SearchReq dto, Pageable pageable) {
